...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { description: @reward.description, name: @reward.name, points: @reward.points }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { description: @reward.description, name: @reward.name, points: @reward.points }
    assert_redirected_to reward_path(assigns(:reward))
  end
